class PaperCorpusBuilder():
    """
    Class responsible for building the paper corpus. It consists of all papers (their paper_ids) that
    ...
    """
    @staticmethod
    def buildCorpus(fold_papers, paperId_col="paper_id"):
        """
        Paper corpus contains all papers in the fold (training and test set). Paper corpus is in
        format (paper_id)

        :param fold_papers all papers part of a fold. Format (paper_id)
        :param paperId_col name of the paper id column
        :return: data frame that contains paper ids from all papers in the corpus. It consists of the column paperId_col.
        """
        ...
        papers_corpus = PapersCorpus(fold_papers, paperId_col)
...
class PapersCorpus:
    ...
    def __init__(self, papers, paperId_col="paper_id"):
        self.papers = papers
