...
class EqualityTest():
    ...
    def IMPvsIMS(self):
        ...
        for i in range(1, 6):
            ...
            user_ids = fold.training_data_frame.select("user_id").distinct().collect()
            shuffle(user_ids)
            ...
            users_dataset = fold.training_data_frame.filter(filter_condition)
            ...
            peers_dataset = nps.transform(users_dataset)
